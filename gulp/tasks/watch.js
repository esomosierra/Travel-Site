...
gulp.task('watch', function() {
    ...
    // GULP IS WATCHING CHANGES FROM "./APP/ASSETS/CSS" MAIN STYLES.CSS TO THE TRANSPILED STYLES.CSS LOCATED IN "./APP/TEMP/STYLES/"
...
gulp.task('cssInject', ['styles'], function() { // "['STYLES']" SERVES AS A DEPENDECIES OF 'CSSINJECT'. 
